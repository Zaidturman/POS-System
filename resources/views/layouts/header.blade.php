...
<ul class="c-header-nav ml-auto mr-4">
    ...
    <li class="c-header-nav-item mr-3">
        <a class="btn btn-primary btn-pill {{ request()->routeIs('app.pos.index') ? 'disabled' : '' }}" href="{{ route('app.pos.index') }}">
            <i class="bi bi-cart mr-1"></i>  {{ trans('public.POSSystem') }}
        </a>
    </li>
    @endcan

    <!--  <select id="langSelect">
        <option value="en" ><a href="home/locale/en">English</a></option>
        <option value="ar"><a href="home/locale/ar">العربية</a></option>
      
    </select> -->

    <button id="myButton"><i class="bi bi-translate" ></i></button>
   ...
   <!--  <script>
    ...
    <li class="c-header-nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-right pt-0">
            <div class="dropdown-header bg-light py-2"><strong>{{ trans('public.Account') }}</strong></div>
            <a class="dropdown-item" href="{{ route('profile.edit') }}">
                <i class="mfe-2  bi bi-person" style="font-size: 1.2rem;"></i>{{ trans('public.Profile') }} 
            </a>
            <a class="dropdown-item" href="#" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                <i class="mfe-2  bi bi-box-arrow-left" style="font-size: 1.2rem;"></i> {{ trans('public.Logout') }}
            </a>
