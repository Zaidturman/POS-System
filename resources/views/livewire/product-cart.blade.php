        ...
        <div class="table-responsive position-relative">
            ...
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <th class="align-middle text-center">{{ trans('public.NetUnitPrice') }}</th>
                    <th class="align-middle text-center">{{ trans('public.Stock') }}</th>
                    <th class="align-middle text-center">{{ trans('public.Quantity') }}</th>
                    <th class="align-middle text-center">{{ trans('public.Discount') }}</th>
                    <th class="align-middle text-center">{{ trans('public.Tax') }}</th>
                    <th class="align-middle text-center">{{ trans('public.SubTotal') }}</th>
                    <th class="align-middle text-center">{{ trans('public.Action') }}</th>
                </tr>
                </thead>
                <tbody>
