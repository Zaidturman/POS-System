...
@section('breadcrumb')
    <ol class="breadcrumb border-0 m-0">
        ...
        <li class="breadcrumb-item active">{{ trans('public.Categories') }}</li>
    </ol>
@endsection
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#categoryCreateModal">
                            {{ trans('public.AddCategory') }} <i class="bi bi-plus"></i>
                        </button>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="categoryCreateModalLabel">{{ trans('public.CreateCategory') }}</h5>
                ...
                <form action="{{ route('expense-categories.store') }}" method="POST">
                    ...
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-primary">{{ trans('public.Create') }} <i class="bi bi-check"></i></button>
                    </div>
                </form>
            </div>
        </div>
