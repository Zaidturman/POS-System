                        ...
                        <form id="purchase-form" action="{{ route('purchases.update', $purchase) }}" method="POST">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="status" id="status" required>
                                            <option {{ $purchase->status == 'Pending' ? 'selected' : '' }} value="Pending">{{ trans('public.Pending') }}</option>
                                            <option {{ $purchase->status == 'Ordered' ? 'selected' : '' }} value="Ordered">{{ trans('public.Ordered') }}</option>
                                            <option {{ $purchase->status == 'Completed' ? 'selected' : '' }} value="Completed">{{ trans('public.Completed') }}</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                            ...
                            <div class="mt-3">
                                <button type="submit" class="btn btn-primary">
                                   {{ trans('public.UpdatePurchase') }}  <i class="bi bi-check"></i>
                                </button>
                            </div>
                        </form>
                    </div>
