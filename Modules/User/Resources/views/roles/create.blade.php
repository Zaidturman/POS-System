...
@section('breadcrumb')
    <ol class="breadcrumb border-0 m-0">
        ...
        <li class="breadcrumb-item"><a href="{{ route('roles.index') }}">{{ trans('public.Roles') }}</a></li>
            ...
            <div class="col-md-12">
                ...
                <form action="{{ route('roles.store') }}" method="POST">
                    ...
                    <div class="form-group">
                        <button type="submit" class="btn btn-primary">{{ trans('public.CreateRole') }} <i class="bi bi-check"></i>
                        </button>
                    </div>
                    <div class="card">
                        <div class="card-body">
                            <div class="form-group">
                                <label for="name">{{ trans('public.RoleName') }} <span class="text-danger">*</span></label>
                            ...
                            <div class="form-group">
                                <label for="permissions">{{ trans('public.Permissions') }} <span class="text-danger">*</span></label>
                            </div>
