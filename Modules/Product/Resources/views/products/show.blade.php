                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped mb-0">
                                <tr>
                                    <th>{{ trans('public.ProductCode') }}</th>
                                    <td>{{ $product->product_code }}</td>
                                </tr>
                                <tr>
                                    <th>{{ trans('public.BarcodeSymbology') }}</th>
                                ...
                                <tr>
                                    <th>{{ trans('public.AlertQuantity') }}</th>
                                    <td>{{ $product->product_stock_alert }}</td>
                                </tr>
                                <tr>
                                    <th>{{ trans('public.Tax') }} </th>
                                    <td>{{ $product->product_order_tax ?? 'N/A' }}</td>
                                </tr>
                                <tr>
                                    <th>{{ trans('public.TaxType') }} </th>
                                    <td>
