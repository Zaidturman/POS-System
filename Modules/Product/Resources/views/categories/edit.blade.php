...
@section('breadcrumb')
    <ol class="breadcrumb border-0 m-0">
        ...
        <li class="breadcrumb-item"><a href="{{ route('product-categories.index') }}">{{ trans('public.Categories') }}</a></li>
                    ...
                    <div class="card-body">
                        <form action="{{ route('product-categories.update', $category->id) }}" method="POST">
                            ...
                            <div class="form-group">
                                <label class="font-weight-bold" for="category_code">{{ trans('public.CategoryCode') }} <span class="text-danger">*</span></label>
                                <input class="form-control" type="text" name="category_code" required value="{{ $category->category_code }}">
                            </div>
                            <div class="form-group">
                                <label class="font-weight-bold" for="category_name">{{ trans('public.CategoryName') }} <span class="text-danger">*</span></label>
