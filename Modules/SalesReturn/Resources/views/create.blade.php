...
@section('breadcrumb')
    <ol class="breadcrumb border-0 m-0">
        ...
        <li class="breadcrumb-item"><a href="{{ route('sale-returns.index') }}">{{ trans('public.SaleReturns') }}</a></li>
                    ...
                    <div class="card-body">
                        ...
                        <form id="sale-return-form" action="{{ route('sale-returns.store') }}" method="POST">
                            ...
                            <div class="form-row">
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="status">{{ trans('public.Status') }} <span class="text-danger">*</span></label>
                                        <select class="form-control" name="status" id="status" required>
                                            <option value="Pending">{{ trans('public.Pending') }}</option>
                                            <option value="Shipped">{{ trans('public.Shipped') }}</option>
                                            <option value="Completed">{{ trans('public.Completed') }}</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="from-group">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="payment_method" id="payment_method" required>
                                                <option value="Cash">{{ trans('public.Cash') }}</option>
                                                <option value="Credit Card">{{ trans('public.CreditCard') }}</option>
                                                <option value="Bank Transfer">{{ trans('public.BankTransfer') }}</option>
                                                <option value="Cheque">{{ trans('public.Cheque') }}</option>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="paid_amount">{{ trans('public.AmountReceived') }}<span class="text-danger">*</span></label>
                            ...
                            <div class="form-group">
                                <label for="note">{{ trans('public.Note') }} ({{ trans('public.IfNeeded') }})</label>
                                <textarea name="note" id="note" rows="5" class="form-control"></textarea>
                            </div>

                            <div class="mt-3">
                                <button type="submit" class="btn btn-primary">
                                   {{ trans('public.CreateSaleReturn') }}  <i class="bi bi-check"></i>
                                </button>
                            </div>
                        </form>
                    </div>
