                        ...
                        <form id="sale-return-form" action="{{ route('sale-returns.update', $sale_return) }}" method="POST">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="status" id="status" required>
                                            <option {{ $sale_return->status == 'Pending' ? 'selected' : '' }} value="Pending">{{ trans('public.Pending') }}</option>
                                            <option {{ $sale_return->status == 'Shipped' ? 'selected' : '' }} value="Shipped">{{ trans('public.Shipped') }}</option>
                                            <option {{ $sale_return->status == 'Completed' ? 'selected' : '' }} value="Completed">{{ trans('public.Completed') }}</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                            ...
                            <div class="mt-3">
                                <button type="submit" class="btn btn-primary">
                                    {{ trans('public.UpdateSaleReturn') }} <i class="bi bi-check"></i>
                                </button>
                            </div>
                        </form>
                    </div>
